...
public class ConferenceApi {
    ...
    private static Profile getProfileFromUser(User user) {
        ...
        if (profile == null) {
            ...
            profile = new Profile(user.getUserId(),
                    extractDefaultDisplayNameFromEmail(email), email, ProfileForm.TeeShirtSize.NOT_SPECIFIED);
        }
        return profile;
    }
    ...
    public Profile saveProfile(final User user, ProfileForm profileForm)
        ...
        ProfileForm.TeeShirtSize teeShirtSize = profileForm.getTeeShirtSize();
        ...
        if (profile == null) {
            ...
            if (teeShirtSize == null) {
                teeShirtSize = ProfileForm.TeeShirtSize.NOT_SPECIFIED;
            }
